...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/22" -d'{
  "userId" : "7",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/23" -d'{
  "userId" : "5",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/24" -d'{
  "userId" : "3",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/25" -d'{
  "userId" : "9",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/26" -d'{
  "userId" : "9",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/27" -d'{
  "userId" : "9",
  "state" : "CART",
  "lineItems" : [
    {
...
echo
echo
curl -s -XPUT -H 'Content-Type: application/json' "$ADDRESS/gutenberg-orders/_doc/28" -d'{
  "userId" : "9",
  "state" : "CART",
  "lineItems" : [
    {
